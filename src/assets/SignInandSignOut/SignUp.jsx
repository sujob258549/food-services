                    ...
                    <div className="card shrink-0 w-full flex-1  bg-base-100 ">
                        ...
                        <form onSubmit={hendelSignUp} className="card-body">
                            ...
                            <div className="form-control mt-6">
                                <button className="btn text-white bg-[#D1A054]">Sign up</button>
                            </div>
                            <p className="text-xl text-center font-medium text-[#D1A054]">Already registered? Go to <Link className='text-red-600' to={'/login'}>log in</Link></p>
                            <p className="text-xl text-center font-medium ">Or sign up with</p>
                        </form>
