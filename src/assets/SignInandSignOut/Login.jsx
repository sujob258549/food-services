...
import signup from '../image/others/authentication2.png';
import './signup.css';
...
const Login = () => {
    ...
    const [showAndHideIcon, setShowAndHideIcon] = useState(false);
    ...
    const handleLogin = async (e) => {
        ...
        const captchaValue = e.target.capta.value;
    ...
    return (
        <div>
            <div className="hero background-img">
                <div className="hero-content shadow flex-col gap-14 lg:gap-20 lg:flex-row-reverse mt-10 md:mt-20 rounded-md p-5 md:p-10">
                    <div className="text-center lg:text-left flex-1">
                        <img className="w-full" src={signup} alt="Signup" />
                    </div>
                    <div className="card shrink-0 w-full flex-1 bg-base-100">
                        <h1 className="text-4xl font-bold text-center pt-8">Login Page</h1>
                        <form onSubmit={handleLogin} className="card-body">
                            ...
                            <div className="form-control relative">
                                ...
                                <input type={showAndHideIcon ? 'text' : 'password'} name="password" placeholder="Enter your password" className="input input-bordered" required />
                                <div className="absolute right-5 bottom-4" onClick={() => setShowAndHideIcon(!showAndHideIcon)}>
                                    {showAndHideIcon ? <FaEyeSlash className="text-xl" /> : <FaEye className="text-xl" />}
                                </div>
                            </div>
                            <div className="form-control">
                                <LoadCanvasTemplate />
                                ...
                                <input type="text" name="capta" placeholder="Captcha" className="input input-bordered" required />
                            </div>
                            <label className="label">
                                <a href="#" className="label-text-alt link link-hover">Forgot password?</a>
                            </label>
                            <div className="form-control mt-6">
                                <button type="submit" className="btn text-white bg-[#D1A054]">Login</button>
                            </div>
                        </form>
                        <p className="text-xl text-center font-medium text-[#D1A054]">
                            Not registered? Go to <Link className="text-red-600" to="/signup">Sign Up</Link>
                        </p>
                        <p className="text-xl text-center font-medium py-5">Or sign up with</p>
                        <div className="mx-auto pb-10">
                            <div className="flex items-center gap-3 sm:gap-x-5">
                                <button onClick={handleGoogleLogin} className="bg-white dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 rounded-lg hover:bg-gray-100 duration-300 transition-colors border px-8 py-2.5">
