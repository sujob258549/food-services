    ...
    return (
        <div className="">
            ...
            <div className="bg-white pb-10 pt-5">
                <h2 className="text-3xl md:ml-10  font-bold py-5 font-cinzel">Total Payments: <span>0</span></h2>
                <div className="shadow-lg rounded-lg overflow-hidden mx-4 md:mx-10">

                    <table className="w-full table-fixed">
                        <thead>
                            <tr className="bg-[#D1A054]">
                                <th className="w-1/4 py-4 px-6 text-left font-bold text-white uppercase">Name</th>
                                <th className="w-1/4 py-4 px-6 text-left font-bold text-white uppercase">Email</th>
                                <th className="w-1/4 py-4 px-6 text-left font-bold text-white uppercase">Phone</th>
                                <th className="w-1/4 py-4 px-6 text-left font-bold text-white uppercase">Status</th>
                            </tr>
                        </thead>
