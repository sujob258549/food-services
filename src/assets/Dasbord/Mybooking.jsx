        ...
        <div className="">
            ...
            <div className="bg-white pb-10 pt-5">
                <div className="flex justify-between flex-wrap items-center py-5 md:pr-5">
                    ...
                    <h2 className="text-3xl md:ml-10  font-bold py-5 font-cinzel">total price: $<span>0</span></h2>
                    ...
                    <table className="w-full table-fixed">
                        <thead>
                            <tr className="bg-[#D1A054]">
                                ...
                                <th className="w-1/6 py-4 px-6 text-left font-bold text-white uppercase">ITEM IMAGE</th>
                                <th className="w-1/4 py-4 px-6 text-left font-bold text-white uppercase">ITEM NAME</th>
                                <th className="w-1/4 py-4 px-6 text-left font-bold text-white uppercase">PRICE</th>
